...
$config = array(
    ...
    'default-sp' => array(
        ...
        'SingleLogoutServiceLocation' => 'https://sp.simplesamlphp.ghsamlstack.localhost/simplesaml/module.php/saml/sp/saml2-logout.php/default-sp',
        'contacts' => [
            [
    ...
    'simple2-sp' => array(
        ...
        'SingleLogoutServiceBinding' => ['urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect'],
        'SingleLogoutServiceLocation' => 'https://sp.simplesamlphp.ghsamlstack.localhost/simplesaml/module.php/saml/sp/saml2-logout.php/simple2-sp',
